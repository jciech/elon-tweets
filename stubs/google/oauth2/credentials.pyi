...
class Credentials(credentials.ReadOnlyScoped, credentials.CredentialsWithQuotaProject):
    token: Any
    expiry: Any
    def __init__(self, token, refresh_token: Any | None = ..., id_token: Any | None = ..., token_uri: Any | None = ..., client_id: Any | None = ..., client_secret: Any | None = ..., scopes: Any | None = ..., default_scopes: Any | None = ..., quota_project_id: Any | None = ..., expiry: Any | None = ..., rapt_token: Any | None = ..., refresh_handler: Any | None = ...) -> None: ...
    @property
...
class UserAccessTokenCredentials(credentials.CredentialsWithQuotaProject):
    def __init__(self, account: Any | None = ..., quota_project_id: Any | None = ...) -> None: ...
