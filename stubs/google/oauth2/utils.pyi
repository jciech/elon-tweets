...
class ClientAuthentication:
    ...
    client_id: Any
    client_secret: Any
    def __init__(self, client_auth_type, client_id, client_secret: Any | None = ...) -> None: ...

class OAuthClientAuthHandler(metaclass=abc.ABCMeta):
    def __init__(self, client_authentication: Any | None = ...) -> None: ...
    def apply_client_authentication_options(self, headers, request_body: Any | None = ..., bearer_token: Any | None = ...) -> None: ...
