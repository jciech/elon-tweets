...
class AccessBoundaryRule:
    def __init__(self, available_resource, available_permissions, availability_condition: Any | None = ...) -> None: ...
    @property
...
class AvailabilityCondition:
    def __init__(self, expression, title: Any | None = ..., description: Any | None = ...) -> None: ...
    @property
    def expression(self): ...
    @expression.setter
...
class Credentials(credentials.CredentialsWithQuotaProject):
    def __init__(self, source_credentials, credential_access_boundary, quota_project_id: Any | None = ...) -> None: ...
    token: Any
    expiry: Any
