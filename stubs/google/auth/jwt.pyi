...
def decode(token, certs: Any | None = ..., verify: bool = ..., audience: Any | None = ...): ...

class Credentials(google.auth.credentials.Signing, google.auth.credentials.CredentialsWithQuotaProject):
    def __init__(self, signer, issuer, subject, audience, additional_claims: Any | None = ..., token_lifetime=..., quota_project_id: Any | None = ...) -> None: ...
    @classmethod
    ...
    def with_claims(self, issuer: Any | None = ..., subject: Any | None = ..., audience: Any | None = ..., additional_claims: Any | None = ...): ...
...
class OnDemandCredentials(google.auth.credentials.Signing, google.auth.credentials.CredentialsWithQuotaProject):
    def __init__(self, signer, issuer, subject, additional_claims: Any | None = ..., token_lifetime=..., max_cache_size=..., quota_project_id: Any | None = ...) -> None: ...
    @classmethod
    def from_service_account_info(cls, info, **kwargs): ...
    @classmethod
    def from_service_account_file(cls, filename, **kwargs): ...
    ...
    def with_claims(self, issuer: Any | None = ..., subject: Any | None = ..., additional_claims: Any | None = ...): ...
    def with_quota_project(self, quota_project_id): ...
    @property
    def valid(self): ...
    def refresh(self, request) -> None: ...
